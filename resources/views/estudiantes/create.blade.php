...
@section('content')
<div class="container">
    <h2><i class="fas fa-user-graduate m-2"></i>Crear Estudiante</h2>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('estudiantes.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre_representante" name="nombre_representante" value="{{ old('nombre_representante') }}">
                </div>
                <div class="mb-3">
                    <label for="cedula_representante" class="form-label">Cédula del Representante</label>
                    <input type="text" class="form-control" id="cedula_representante" name="cedula_representante" value="{{ old('cedula_representante') }}">
                </div>
                <div class="mb-3">
                    <label for="telefono_representante" class="form-label">Teléfono del Representante</label>
                    <input type="tel" class="form-control" id="telefono_representante" name="telefono_representante" value="{{ old('telefono_representante') }}">
                </div>
                <div class="mb-3">
                    <label for="correo_representante" class="form-label">Correo del Representante</label>
                    <input type="email" class="form-control" id="correo_representante" name="correo_representante" value="{{ old('correo_representante') }}">
                </div>
                <div class="mb-3">
                        ...
                        @foreach($asignaturas as $asignatura)
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="asignaturas[]" value="{{ $asignatura->id }}" id="asignatura_{{ $asignatura->id }}" {{ (is_array(old('asignaturas')) && in_array($asignatura->id, old('asignaturas'))) ? 'checked' : '' }}>
